...
static int mdss_dsi_panel_on(struct mdss_panel_data *pdata)
{
	...
	if (!strcmp(panel_name, "qcom,mdss_dsi_r63350_ebbg_fhd_video")) {
		pr_err("klozz mdss_dsi_panel.c :mdss_dsi_panel_on panel_name = %s \n", panel_name);
		...
		case 0x0001:
		{
			...
			pr_err("klozz mdss_dsi_panel.c: warm gamma \n");
			break;
		}
		case 0x0002:
		{
			...
			pr_err("klozz mdss_dsi_panel.c: default gamma \n");
			break;
		}
		case 0x0003:
		{
			...
			pr_err("klozz mdss_dsi_panel.c: cold gamma \n");
			break;
		}
